...
static void canzero_serialize_canzero_message_levitation_board1_stream_errors(canzero_message_levitation_board1_stream_errors* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_heartbeat_miss & (0xFF >> (8 - 1))) << 3;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_vdc_voltage & (0xFF >> (8 - 2))) << 4;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_current_left & (0xFF >> (8 - 2))) << 6;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_current_right & (0xFF >> (8 - 2))) << 8;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_input_current & (0xFF >> (8 - 2))) << 10;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_temperature_left & (0xFF >> (8 - 2))) << 12;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_temperature_right & (0xFF >> (8 - 2))) << 14;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_mcu_temperature & (0xFF >> (8 - 2))) << 16;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_airgap_left_invalid & (0xFF >> (8 - 1))) << 18;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_airgap_right_invalid & (0xFF >> (8 - 1))) << 19;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_vdc_voltage_invalid & (0xFF >> (8 - 1))) << 20;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_current_left_invalid & (0xFF >> (8 - 1))) << 21;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_current_right_invalid & (0xFF >> (8 - 1))) << 22;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_temperature_left_invalid & (0xFF >> (8 - 1))) << 23;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_temperature_right_invalid & (0xFF >> (8 - 1))) << 24;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_mcu_temperature_invalid & (0xFF >> (8 - 1))) << 25;
  ((uint64_t*)data)[0] |= ((uint64_t)msg->m_last_node_missed) << 26 ;
}
...
static void canzero_serialize_canzero_message_levitation_board1_stream_controller_debug_3(canzero_message_levitation_board1_stream_controller_debug_3* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[1] |= left_current_controller_target_48 << 16;
}
static void canzero_serialize_canzero_message_levitation_board1_stream_controller_debug_4(canzero_message_levitation_board1_stream_controller_debug_4* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[1] |= right_current_controller_target_48 << 16;
}
static void canzero_serialize_canzero_message_levitation_board1_stream_controller_debug5(canzero_message_levitation_board1_stream_controller_debug5* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[0] = left_airgap_controller_airgap_0;
  ...
  ((uint32_t*)data)[0] |= left_airgap_controller_error2_16 << 16;
  ...
  ((uint32_t*)data)[1] = right_airgap_controller_airgap_32;
  ...
  ((uint32_t*)data)[1] |= right_airgap_controller_error2_48 << 16;
}

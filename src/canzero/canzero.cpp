...
static PROGMEM void canzero_handle_get_req(canzero_frame* frame) {
  ...
  case 50: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_airgap_pid_rx_fragmentation_buffer, 6, 50, msg.m_header.m_client_id);
    break;
  }
  case 51: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_airgap_pid_extra_rx_fragmentation_buffer, 6, 51, msg.m_header.m_client_id);
    break;
  }
  case 52: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_current_pi_rx_fragmentation_buffer, 4, 52, msg.m_header.m_client_id);
    break;
  }
  case 53: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_current_pi_extra_rx_fragmentation_buffer, 6, 53, msg.m_header.m_client_id);
    break;
  }
  case 54: {
...
void canzero_init() {
  __oe_config_hash = 18135772835215668955ull;
  __oe_build_time = {
    .m_year = BUILD_YEAR,
    .m_month = BUILD_MONTH,
    .m_day = BUILD_DAY,
...
void canzero_send_airgap_pid() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_airgap_pid_send_fragmentation_buffer, 6, 50, 255);
...
void canzero_send_airgap_pid_extra() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_airgap_pid_extra_send_fragmentation_buffer, 6, 51, 255);
...
void canzero_send_current_pi() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_current_pi_send_fragmentation_buffer, 4, 52, 255);
...
void canzero_send_current_pi_extra() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_current_pi_extra_send_fragmentation_buffer, 6, 53, 255);

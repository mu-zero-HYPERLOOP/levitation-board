...
static void canzero_serialize_canzero_message_levitation_board2_stream_errors(canzero_message_levitation_board2_stream_errors* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[0] |= msg->m_last_node_missed << 18;
}
static void canzero_serialize_canzero_message_levitation_board2_stream_temperatures(canzero_message_levitation_board2_stream_temperatures* msg, canzero_frame* frame) {
  ...
  frame->id = 0x5A;
  frame->dlc = 3;
  uint32_t magnet_temperature_left1_0 = ((msg->m_magnet_temperature_left1 - -1) / 0.592156862745098) + 0.5f;
  if (magnet_temperature_left1_0 > 0xFF) {
    magnet_temperature_left1_0 = 0xFF;
  }
  ((uint32_t*)data)[0] = magnet_temperature_left1_0;
  uint32_t magnet_temperature_right1_8 = ((msg->m_magnet_temperature_right1 - -1) / 0.592156862745098) + 0.5f;
  if (magnet_temperature_right1_8 > 0xFF) {
    magnet_temperature_right1_8 = 0xFF;
  }
  ((uint32_t*)data)[0] |= magnet_temperature_right1_8 << 8;
  ...
  for (uint8_t i = 0; i < 100; ++i) {
    ...
    switch (job->tag) {
      ...
      case 3: {
        ...
        stream_message.m_magnet_temperature_left1 = __oe_magnet_temperature_left1;
        stream_message.m_magnet_temperature_right1 = __oe_magnet_temperature_right1;
...
static PROGMEM void canzero_handle_get_req(canzero_frame* frame) {
  ...
  case 29: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_vdc_voltage_rx_fragmentation_buffer, 7, 29, msg.m_header.m_client_id);
    break;
  }
  case 30: {
  ...
  case 33: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_current_rx_fragmentation_buffer, 7, 33, msg.m_header.m_client_id);
    break;
  }
  case 34: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_input_current_rx_fragmentation_buffer, 7, 34, msg.m_header.m_client_id);
    break;
  }
  case 35: {
  ...
  case 41: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_temperature_rx_fragmentation_buffer, 7, 41, msg.m_header.m_client_id);
    break;
  }
  case 42: {
  ...
  case 43: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_mcu_temperature_rx_fragmentation_buffer, 7, 43, msg.m_header.m_client_id);
    break;
  }
  case 44: {
  ...
  case 54: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_airgap_pid_rx_fragmentation_buffer, 6, 54, msg.m_header.m_client_id);
    break;
  }
  case 55: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_airgap_pid_extra_rx_fragmentation_buffer, 4, 55, msg.m_header.m_client_id);
    break;
  }
  case 56: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_current_pi_rx_fragmentation_buffer, 4, 56, msg.m_header.m_client_id);
    break;
  }
  case 57: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_current_pi_extra_rx_fragmentation_buffer, 6, 57, msg.m_header.m_client_id);
    break;
  }
  case 58: {
...
void canzero_send_error_level_config_vdc_voltage() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_vdc_voltage_send_fragmentation_buffer, 7, 29, 255);
...
void canzero_send_error_level_config_magnet_current() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_current_send_fragmentation_buffer, 7, 33, 255);
...
void canzero_send_error_level_config_input_current() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_input_current_send_fragmentation_buffer, 7, 34, 255);
...
void canzero_send_error_level_config_magnet_temperature() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_temperature_send_fragmentation_buffer, 7, 41, 255);
...
void canzero_send_error_level_config_mcu_temperature() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_mcu_temperature_send_fragmentation_buffer, 7, 43, 255);
...
void canzero_send_airgap_pid() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_airgap_pid_send_fragmentation_buffer, 6, 54, 255);
...
void canzero_send_airgap_pid_extra() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_airgap_pid_extra_send_fragmentation_buffer, 4, 55, 255);
...
void canzero_send_current_pi() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_current_pi_send_fragmentation_buffer, 4, 56, 255);
...
void canzero_send_current_pi_extra() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_current_pi_extra_send_fragmentation_buffer, 6, 57, 255);

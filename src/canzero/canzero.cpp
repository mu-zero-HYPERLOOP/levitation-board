...
static const uint32_t controller_debug_1_interval = 5;
...
static const uint32_t controller_debug_2_interval = 5;
...
static const uint32_t controller_debug_3_interval = 5;
...
void canzero_init() {
  __oe_config_hash = 12134510362684747630ull;
  __oe_build_time = {
    .m_year = BUILD_YEAR,
    .m_month = BUILD_MONTH,
    .m_day = BUILD_DAY,

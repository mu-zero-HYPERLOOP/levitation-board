...
static void canzero_serialize_canzero_message_levitation_board3_stream_errors(canzero_message_levitation_board3_stream_errors* msg, canzero_frame* frame) {
  ...
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_vdc_voltage & (0xFF >> (8 - 2))) << 4;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_current_left & (0xFF >> (8 - 2))) << 6;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_current_right & (0xFF >> (8 - 2))) << 8;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_input_current & (0xFF >> (8 - 2))) << 10;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_temperature_left & (0xFF >> (8 - 2))) << 12;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_magnet_temperature_right & (0xFF >> (8 - 2))) << 14;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_mcu_temperature & (0xFF >> (8 - 2))) << 16;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_airgap_left_invalid & (0xFF >> (8 - 1))) << 18;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_airgap_right_invalid & (0xFF >> (8 - 1))) << 19;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_vdc_voltage_invalid & (0xFF >> (8 - 1))) << 20;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_current_left_invalid & (0xFF >> (8 - 1))) << 21;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_current_right_invalid & (0xFF >> (8 - 1))) << 22;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_temperature_left_invalid & (0xFF >> (8 - 1))) << 23;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_magnet_temperature_right_invalid & (0xFF >> (8 - 1))) << 24;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_mcu_temperature_invalid & (0xFF >> (8 - 1))) << 25;
  ((volatile uint64_t*)data)[0] |= ((uint64_t)msg->m_last_node_missed) << 26 ;
}
...
static PROGMEM void canzero_handle_get_req(canzero_frame* frame) {
  ...
  case 32: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_vdc_voltage_rx_fragmentation_buffer, 7, 32, msg.m_header.m_client_id);
    break;
  }
  case 33: {
  ...
  case 36: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_current_rx_fragmentation_buffer, 7, 36, msg.m_header.m_client_id);
    break;
  }
  case 37: {
  ...
  case 39: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_input_current_rx_fragmentation_buffer, 7, 39, msg.m_header.m_client_id);
    break;
  }
  case 40: {
  ...
  case 45: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_temperature_rx_fragmentation_buffer, 7, 45, msg.m_header.m_client_id);
    break;
  }
  case 46: {
  ...
  case 59: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_airgap_pid_rx_fragmentation_buffer, 6, 59, msg.m_header.m_client_id);
    break;
  }
  case 60: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_airgap_pid_extra_rx_fragmentation_buffer, 4, 60, msg.m_header.m_client_id);
    break;
  }
  case 61: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_current_pi_rx_fragmentation_buffer, 4, 61, msg.m_header.m_client_id);
    break;
  }
  case 62: {
    {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_current_pi_extra_rx_fragmentation_buffer, 6, 62, msg.m_header.m_client_id);
    break;
  }
  case 63: {
...
void canzero_send_error_level_config_vdc_voltage() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_vdc_voltage_send_fragmentation_buffer, 7, 32, 255);
...
void canzero_send_error_level_config_magnet_current() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_current_send_fragmentation_buffer, 7, 36, 255);
...
void canzero_send_error_level_config_input_current() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_input_current_send_fragmentation_buffer, 7, 39, 255);
...
void canzero_send_error_level_config_magnet_temperature() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_temperature_send_fragmentation_buffer, 7, 45, 255);
...
void canzero_send_airgap_pid() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_airgap_pid_send_fragmentation_buffer, 6, 59, 255);
...
void canzero_send_airgap_pid_extra() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_airgap_pid_extra_send_fragmentation_buffer, 4, 60, 255);
...
void canzero_send_current_pi() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_current_pi_send_fragmentation_buffer, 4, 61, 255);
...
void canzero_send_current_pi_extra() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_current_pi_extra_send_fragmentation_buffer, 6, 62, 255);

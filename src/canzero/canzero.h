...
static const uint32_t canzero_message_levitation_board2_stream_temperatures_id = 0xB8;
typedef struct {
  float m_vdc_voltage;
...
static const uint32_t canzero_message_levitation_board2_stream_voltage_and_currents_id = 0xD8;
typedef struct {
  float m_airgap_left;
...
static const uint32_t canzero_message_levitation_board2_stream_airgaps_id = 0xD9;
typedef struct {
...
static const uint32_t canzero_message_levitation_board2_stream_controller_debug_1_id = 0x119;
typedef struct {
...
static const uint32_t canzero_message_levitation_board2_stream_controller_debug_2_id = 0x58;
typedef struct {
...
static const uint32_t canzero_message_levitation_board2_stream_controller_debug_3_id = 0x78;
typedef struct {
...
static const uint32_t canzero_message_levitation_board2_stream_controller_debug_4_id = 0x98;
typedef struct {
...
static const uint32_t canzero_message_levitation_board2_stream_controller_debug5_id = 0xF9;
typedef struct {
  uint8_t m_node_id;
